...
<head>
    ...
    <title>Услуги — Свердловскавтодор</title>
        ...
        <div class="container">
            <div class="about">
                ...
                <div class="text element-animation delay">
                    <p>Наша компания предлагает выполнение работ любой сложности в кратчайшие сроки с использованием
                        сложных материалов для стабилизации конструкций, разделения слоев, усиления асфальтового
                        покрытия, защиты склона и другие элементы дорожного строительства.</p>
                    <p>При строительстве дорог большое значение имеет соблюдение технологий всего процесса, поэтому наши
                        специалисты учитывают основные моменты при выбора материалов, укрепления почвы, расчете защитной
                        деформации и нагрузок.</p>
                    <p>При строительстве дорог следует помнить, что незначительный ущерб может перерасти в очень опасные
                        деформации конструкций. Это, в свою очередь, препятствует движению на дороге и в конечном итоге
                        приводит к дополнительным расходам на ремонт.</p>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="services">
                ...
                <div class="more">
                    <a class="btn" href="profile.php">Оставить заявку</a>
                </div>
            </div>
        </div>
    </main>
